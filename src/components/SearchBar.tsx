...
const SearchBar: Component<SearchBarProperties> = (properties) => {
    ...
    return (
        <div class="w-full relative group">
            <div class="absolute inset-0 bg-primary/10 rounded-2xl blur-xl opacity-0 group-focus-within:opacity-100 transition-opacity duration-300" />
            <div class="relative flex items-center">
                ...
                <input
                    ...
                    class="w-full pl-12 pr-4 py-4 rounded-2xl border-2 border-border bg-card text-foreground
